...
function networkStop() {
	...
	if [ "$MODE" != "restart" ]; then
		...
		sudo rm -rf channel-artifacts/* .block channel-artifacts/*.tx organizations/ordererOrganizations organizations/peerOrganizations chaincode
		
		sudo rm -rf organizations/fabric-ca/org2/org2_ca/org2admin organizations/fabric-ca/org2/org2_tls/org2admin organizations/fabric-ca/org2/org2_ca/tls organizations/fabric-ca/org1/org1_ca/tls 
	fi	
